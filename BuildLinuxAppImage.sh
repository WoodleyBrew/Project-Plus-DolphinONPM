...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/project-plus-dolphinONPM_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/project-plus-dolphinONPM-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/project-plus-dolphinONPM/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/project-plus-dolphinONPM
sed -i 's/env QT_QPA_PLATFORM=xcb project-plus-dolphinONPM/project-plus-dolphinONPM/g' ./AppDir/usr/share/applications/project-plus-dolphinONPM.desktop
